...
namespace Habr.BusinessLogic.Services.Interfaces
{
    ...
    {
        public Task<RegistrationOrLoginUserDTO> LogInAsync(string email, string password);
        public Task<RegistrationOrLoginUserDTO> RegisterAsync(string name, string email, string password);
